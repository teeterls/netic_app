        ...
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            <li class="nav-item">
                <form action="ServletController" method="post">
                    <input class="btn btn-warning mt-3" type="submit" value="Inicio" name="principal">
                </form>
            </li>
            <li class="nav-item">
                <form action="ServletController" method="post">
                    <input class="btn btn-warning mt-3 ml-2" type="submit" value="Mi perfil" name="miperfil">
                </form>
            </li>
            <li class="nav-item">
